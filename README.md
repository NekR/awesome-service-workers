...
- [`offline-plugin` for webpack](https://github.com/NekR/offline-plugin) - Brings offline support to your webpack build via ServiceWorker and AppCache, no configuration required
